import BriefImage1 from "../Images/Brief-Image1.png"
function BriefAboutiRise (){
    return <div>
        ...
        <div className="flex gap-10">
            ...
            <div className="mt-16">
                    <div className="w-[400px] mt-[25px] font-poppins">
                    ...
                    <div className="w-[400px] mt-[15px] font-poppins">
                        <h1 className="font-bold text-[30px] mb-1"> What We Do</h1>
                    ...
                    <div className="w-[400px] mt-[10px] font-poppins">
                        <h1 className="font-bold text-[30px] mb-1"> How We Do It</h1>
            ...
            <div className="w-full flex gap-2">
                ...
                <div className="w-[250px]">
                    <div className="w-full h-[180px] bg-gray-400 rounded-lg">

                    </div>
                    <div className="w-full h-[330px] mt-3 bg-gray-400 rounded-lg">
                ...
                <div className="w-[300px] ">
                    ...
                    <div className="w-full mt-3  h-[330px]  bg-gray-400 rounded-lg">

                    </div>
                    <div className="w-full  mt-3 h-[180px] bg-gray-400 rounded-lg">
