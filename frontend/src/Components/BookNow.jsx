...
function BookNow() {
  return (
    <div className="relative w-full h-[500px] rounded-lg">
      ...
      {/* Overlay content */}
      <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-orange/70 flex justify-around items-center">
        {/* Left text content */}
        <div className="text-white font-poppins max-w-[450px] space-y-4 p-4">
