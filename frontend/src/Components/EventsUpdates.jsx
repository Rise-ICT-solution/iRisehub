...
function EventUpdate ({image, title, description, date}){
    return <div className="w-[300px] relative font-poppins  pb-[30px] shadow-lg rounded-md shadow-gray-400  bg-white">
                ...
                <div className="px-[10px] pt-4">
                    ...
                    <p className="mt-3 mb-20"> {description} </p>
                    <button className=" px-3 absolute bottom-4  h-[40px] mt-4 hover:bg-transparent hover:text-black hover:border-orange rounded-[5px] hover:border-2 text-[16px] text-white flex items-center gap-2 bg-orange"> View more <FaArrowRight />                        </button>
                </div>
